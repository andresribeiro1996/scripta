...
export function HomeScreen() {
  ...
  return <Screen top={false}>
    ...
    <Sheet visible={Boolean(selected)} title="Your mural" onClose={() => setSelectedId(null)}><ScrollView contentContainerStyle={styles.page}>
      ...
      {original?.type === "shelf" && original.collectionId ? <Button label="Open collection" onPress={() => { setSelectedId(null); router.push(`/collection/${original.collectionId}` as never); }} /> : null}
