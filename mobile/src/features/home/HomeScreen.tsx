...
export function HomeScreen() {
  ...
  }, [library.refetch, dashboard.refetch]));
        ...
        <View style={styles.grow}>
          ...
          {!books.length ? (
            ...
            <ScrollView
              ...
              refreshControl={
                <RefreshControl
                  refreshing={library.isRefetching || dashboard.isRefetching}
                  onRefresh={() => {
                    void library.refetch();
                    void dashboard.refetch();
                  }}
...
function SectionHeader({ title, count }: { title: string; count?: string }) {
  ...
  return (
    <View style={styles.sectionHeader}>
      <Text {...dynamicType} style={[typography.body, styles.heading, { color: colors.text }]}>{title}</Text>
