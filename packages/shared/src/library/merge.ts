...
// DashboardPage).
//
// This intentionally lives entirely on the client, not the backend: the
...
// understand book shape, and shouldn't have to just for this. Each
// client already understands book shape (it's what parses every import
